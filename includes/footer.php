<footer class="bg-[#2B2B43] pt-12 pb-8 px-8 md:px-16 w-full mt-auto font-sans">
    <div class="max-w-[1200px] mx-auto">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start gap-10 mb-12">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-8">
                    <a href="#" class="flex items-center gap-2 text-[#EAA07E] hover:text-[#E88D57]">
        ...
        <div class="flex justify-center mb-8">
            <img src="assets/logo.png" alt="Salma Shofa Logo" class="h-[80px] md:h-[100px] w-auto object-contain transform translate-x-6 -translate-y-4">
        </div>
