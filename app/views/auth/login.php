        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    colors: { brand: { orange: '#E88D57', dark: '#1A1A24', input: '#2B2B3A' } }
                }
            }
        }
    </script>
...
<body class="bg-[#FAFAFB] font-sans h-screen flex items-center justify-center p-4 relative">
    ...
    <a href="/" class="absolute top-6 left-6 md:top-8 md:left-8 w-12 h-12 bg-white border border-gray-200 rounded-full flex items-center justify-center text-gray-500 hover:text-brand-orange hover:shadow-md transition-all z-50 group">
    ...
    <div class="w-full max-w-[1000px] bg-white rounded-[32px] shadow-2xl flex flex-col md:flex-row overflow-hidden min-h-[600px] relative z-10">
        ...
        <div class="w-full md:w-1/2 relative hidden md:block">
            <img src="https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?auto=format&fit=crop&w=800&q=80" class="absolute inset-0 w-full h-full object-cover">
        ...
        <div class="w-full md:w-1/2 bg-brand-dark p-10 lg:p-14 flex flex-col justify-center relative">
            ...
            <div class="mt-10 flex flex-col items-center justify-center gap-4 relative z-10">
                <a href="/" class="text-[12px] font-bold text-gray-400 hover:text-brand-orange transition-colors flex items-center gap-2 md:hidden">
